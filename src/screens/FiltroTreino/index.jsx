...
export default function FiltroTreino({ navigation }) {
  return (
    <Container>
      ...
      <Card
        onPress={() =>
          navigation.navigate("Treino", { categoria: "matematica" })
        }
      >
        <Image
          source={GROUP_IMAGES.matematica}
      ...
      <Card
        onPress={() =>
          navigation.navigate("Treino", { categoria: "ciencias_natureza" })
        }
      >
        <Image
          source={GROUP_IMAGES.ciencias_natureza}
          style={{ width: 40, height: 40, marginRight: 15 }}
        />
      ...
      <Card
        onPress={() =>
          navigation.navigate("Treino", { categoria: "ciencias_humanas" })
        }
      >
        <Image
          source={GROUP_IMAGES.ciencias_humanas}
          style={{ width: 40, height: 40, marginRight: 15 }}
        />
      ...
      <Card
        onPress={() =>
          navigation.navigate("Treino", { categoria: "linguagens" })
        }
      >
        <Image
          source={GROUP_IMAGES.linguagens}
          style={{ width: 40, height: 40, marginRight: 15 }}
        />
      ...
      <Card
        onPress={() =>
          navigation.navigate("Treino", { categoria: "informatica" })
        }
      >
        <Image
          source={GROUP_IMAGES.informatica}
          style={{ width: 40, height: 40, marginRight: 15 }}
        />
