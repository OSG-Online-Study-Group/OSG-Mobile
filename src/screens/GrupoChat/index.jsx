...
import {
  ...
  AvatarWrapper, AvatarImage, AvatarText,
  MessageRow, MessageWrapper, SenderName,
  MessageMeta, MessageTime,
  DeletedMessage, DeletedText, DeleteButton,
} from "./styles";
...
export default function GrupoChat({ route, navigation }) {
  ...
  const {
    ...
    handleSend, handleDelete, user, isAdmin,
  } = useChat(groupId);
